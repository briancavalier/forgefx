// @flow
import { type ConsoleHandler, type Result, type Step, run, withHandler, sync } from '../../packages/core'
...
run(() => assert.deepStrictEqual(['you typed: hi', 'you typed: hello', 'Bye!'], logged),
